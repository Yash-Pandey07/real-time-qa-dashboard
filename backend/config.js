...
module.exports = {
  ...
  selfHealing: {
    repos: [
      ...
      { owner: 'gautamakky10',   repo: 'agentic-self-healing-framework-gv', label: 'Selenium Self-Healing - 1',        hasCiSummary: true,  hasDashboardData: true  },
      { owner: 'priya-thapliyal', repo: 'agentic-self-healing-framework',    label: 'Selenium Self-Healing - 2', hasCiSummary: true, hasDashboardData: true  },
